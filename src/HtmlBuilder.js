...
class HtmlBuilder {
     ...
     * </div>
     */
    static audioWrapper(audioElement) {
        let div = document.createElement("div");
     ...
     * @param {String} name Element name: h1 / h3
     ...
     * </h1>
     */
    static canvasSubHeader(className, name) {
     ...
     * @returns {HTMLDivElement}
     */
    static canvasHeader(subheaders) {
        let div = document.createElement("div");
     ...
     */
    static typedButton(type, content) {
